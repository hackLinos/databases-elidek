...
<?php 
    ...
    $conn = OpenCon();
            ...
            $query="SELECT ID_ergouuu as ID_ergou_Accounting  , ID_ereunitiii as ID_ereuniti
            ...
            JOIN ergazetai_se_ergo on epistimoniko_pedio_ergou.ID_ergouuu = ergazetai_se_ergo.ID_ergouu
               where ID_epistimoniko_pediouu = 8  AND  now() < Hmerominia_liksis_ergou";
    ...
    echo '<h1 style="margin-top: 5rem;">No page found!</h1>';
        ...
        echo '<div class="table-responsive">';
            echo '<table class="table">';
                echo '<thead>';
                    echo '<tr>';
                        echo '<th>ID ergou Accounting</th>';
