...
<?php 
    ...
    $conn = OpenCon();
            ...
            $query="SELECT ID_ergouuu as ID_ergou_Biology  , ID_ereunitiii as ID_ereuniti
            ...
            JOIN ergazetai_se_ergo on epistimoniko_pedio_ergou.ID_ergouuu = ergazetai_se_ergo.ID_ergouu
               where ID_epistimoniko_pediouu = 7  AND  now() < Hmerominia_liksis_ergou";
